...
class Ultrassonico(object):
    ...
    def subscribe_schedule(self):
        subscribe.callback(self.on_message_schedule, self.__config['topics']['topic_scheduler'], hostname = self.__config['mqtt_broker']['host'], port = self.__config['mqtt_broker']['port'])
