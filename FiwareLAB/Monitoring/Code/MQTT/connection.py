...
class Connection(object):
    ...
    def subscribe_schedule(self):
        try:
            ...
            subscribe.callback(self.on_message_schedule, self.__config['topics']['topic_scheduler'], hostname = self.__config['mqtt_broker']['host'], port = self.__config['mqtt_broker']['port']) #se inscreve no topico de horarios
    ...
    def subscribe_raspberry(self):
        ...
        try:
            subscribe.callback(self.callback, [self.__config['topics']['topic_raspberry'], self.__config['topics']['topic_heartbeat']], hostname = self.__config['mqtt_broker']['host'], port = self.__config['mqtt_broker']['port'])
        except:
            pass
